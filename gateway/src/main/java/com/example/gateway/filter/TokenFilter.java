...
//                System.out.println("req: " + request.getId() + ", " + request.getMethod() +" : "
...
//                    Mono.fromRunnable(()->{
//                        if (config.getLogging()) {
//                            System.out.println("res: " + request.getId() + ", " + response.getStatusCode());}
//                    })
//            )
            ;
        };
    ...
    public boolean isValidToken(ServerHttpRequest request) {
        ...
        if (bearerToken.startsWith("Bearer ")) {
            return jwtService.parseToken(bearerToken.replace("Bearer ", ""));
        }
        return false;
    }

    public Mono<Void> onError(ServerHttpResponse response, String msg, HttpStatus code) {
